# Claude Code Token-Stack — Komplettpaket v5.1
...
| Pfad | Was |
|---|---|
| `KONZEPT-v5.md` | Referenzfassung (v5.1): drei Gesetze, vier Mechanismen, neun Flächen, Stufen 0–7, Regeln R1–R8, Konfliktmatrix, Migration |
...
| `scripts/repo-audit.py` | reproduziert die 1-bis-100-Bewertung (A/B/C gemessen, D geprüfte Korrektheit) |
| `scripts/judgments.json` | Korrektheitsurteil und Evidenztier je Repo; ohne Prüfung 0 Punkte |
...
python3 scripts/repo-audit.py --repos scripts/repos.txt --judgments scripts/judgments.json --out audit.json
```
...
- `repo-catalog-v4.json` — 371 Repositories, 368 kanonisch distinct, Schema 4.2
- `VERGLEICH-RUNDE2.md` — Abgleich der drei Zweitvalidierungen, zwei bestätigte Fehler in der eigenen Arbeit
