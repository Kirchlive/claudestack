...
| 8 | Strukturdaten (JSON/YAML-Syntaxkosten) | punktuell | niedrig | toonify-mcp (Pin ≥ 0.8.2, Format-Pilot) |
...
| PCIRCLE-AI/toonify-mcp | **78** | Format (Fläche 8) | Format-Pilot, **Pin ≥ 0.8.2** (U1) |
...
| toonify-mcp < 0.8.1 × alles | Ersetzung statt Doppelung | Pin ≥ 0.8.2 (U1) |
...
|---|---|---|---|
| toonify-mcp | konditional/defekt | rehabilitiert, Pin ≥ 0.8.2 | Fix 12.08., 63,8 % gemessen (U1) |
