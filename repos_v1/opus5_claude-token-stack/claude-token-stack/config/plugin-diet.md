...
| Behalten | Begründung |
|---|---|
| `ponytail@ponytail` | Einziger Tier-1-belegter Werkzeuggewinn im ganzen Feld (−10,3 %, p = 0,004). Σ 97. |
...
`/context` vorher/nachher **plus** `node hooks/prefix-budget.mjs --report` vorher/nachher. Zwei Zahlen, eine gemessen, eine geschätzt — die Abweichung zwischen beiden lag im Test bei 6,5 %.
