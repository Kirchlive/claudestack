...
bewertungsmodell:
  ...
  Konvergenz_10: "Datensatzübergreifende Empfehlungen (4=10 … 1≈3)"
...
|---|---|---|---|---|
| T1 | Vermeidbarer Prefix/Session (Stufe 0) | 20 Skills×~100 [SEK] + Guidance 3.500 [GEM] + MCP 286 [GEM] + Git-Instr. 1.800 [PRJ] | **~7.586 Tokens/Session** (mit Memory-MCP-Verzicht ~6.500 → ~14.086) | mittel (2 GEMESSEN, 2 Fremd) |
...
| PCIRCLE-AI/toonify-mcp | ✅ | ❌→✅ (Fix 0.8.x) | 🔶 | ✅ | 64 | 1 | MIT |
...
|---|---|---|
| U1 | **toonify-mcp „defekt" (GPT56) vs. „Kern #5" (KIMI)** | **Beides zeitabhängig richtig.** Der additionalContext-Defekt war real, wurde aber in **0.8.0/0.8.1 (12.08.2026)** gefixt: Hook nutzt jetzt `updatedToolOutput` (ersetzend), Read/Grep/WebFetch-Adapter quellen-/laufzeitverifiziert, **63,8 % reale Token-Reduktion (Read, 500-Zeilen-JSON, cl100k)** gemessen, ReDoS-Fix. → **Rehabilitiert** als Format-Kandidat, mit Versionspin ≥0.8.1. |
...
| U9 | Issue-Tiefe je Repo | **nicht tiefer geprüft (Rate-Limit)** außer: rtk (#1155/#2345/#3152/CVE-2026-33068 — Absage bestätigt), headroom (#2438 — Absage bestätigt), claude-mem (#1719/#3480 — optional), CCR (193 Tool-Calling-Issues — konditional), toonify (ReDoS gefixt 0.8.1). |
...
| PCIRCLE-AI/toonify-mcp | 15 | 20 | 15 | 13 | 8 | 7 | **78** | ⬆ rehabilitiert (Fix 0.8.1), Format-Pilot mit Pin ≥0.8.1 |
...
|---|---|---|
| rtk-ai/rtk | CVE-2026-33068, #1155/#2345/#3152, +7,6 %/+18 % gemessen | Issues geschlossen + unabhängige Neu-Messung |
...
|---|---|---|---|
| toonify-mcp | konditional | rehabilitiert + Pin ≥0.8.1 | Fix 0.8.0/0.8.1 (12.08.), 63,8 % gemessen |
