...
| | **Summe (max 160)** | **142** | **127** | **103** | **109** | |

**Erste grobe Gesamtbewertung (Datenlage 13.08.2026):** OPUS_V4 führt als vollständigster, selbstkritischster und mit Eigenmessungen unterlegter Datensatz; GPT56 ist die stärkste native/technische Korrekturinstanz mit dem besten Rollout; KIMI bleibt Referenz für Mechanismus-Logik, Cache/Proxy/Memory-Tiefe und Ladder; K3 (unsere Validierung) ist stark bei Agenten-Ranking und externer Verifikation, aber ohne eigenen Katalog/Eigenmessungen auf Platz 4 der Datenbasis.
