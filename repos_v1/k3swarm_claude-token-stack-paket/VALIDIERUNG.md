...
|---|---|---|
| **OPUS_V4** | **142** | vollständigster, selbstkritischster Datensatz; Inventar + Eigenmessungen |
| **GPT56** | **127** | stärkste native/technische Korrektur, bester Rollout, einziger produktionsnaher Code |
| **KIMI** | **109** | Referenz für Mechanismus-Logik, Cache/Proxy/Memory-Tiefe, Ladder-Urheber |
| **K3** (unsere Validierung) | **103** | Agenten-Ranking, externe Verifikation, kein eigener Katalog |
...
|---|---|---|---|
| T1 | Vermeidbarer Prefix/Session | **~7.586 Tokens** (mit Memory-MCP-Verzicht ~14.086) | mittel (2 GEMESSEN, 2 Fremd) |
...
| PCIRCLE-AI/toonify-mcp | 15 | 20 | 15 | 13 | 8 | 7 | **78** | rehabilitiert, Pin ≥ 0.8.1 |
...
rtk (CVE-2026-33068, +7,6 %/+18 % gemessen) · caveman (8,5 % statt 65 %) ·
...
|---|---|---|
| U1 | toonify-mcp „defekt" vs. „Kern #5" | Beides zeitabhängig richtig: additionalContext-Defekt real, in **0.8.0/0.8.1 (12.08.) gefixt** (`updatedToolOutput`, 63,8 % gemessen, ReDoS-Fix) → rehabilitiert mit Pin ≥ 0.8.1 |
