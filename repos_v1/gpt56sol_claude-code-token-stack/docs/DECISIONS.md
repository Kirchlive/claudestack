...
- Entscheidung: Pro Hook-/Retrieval-/Memory-/Proxy-Surface höchstens ein Mutator.
  Aktive Bash-Ausgabe und Read haben den lokalen Dispatcher als einzigen Owner.
...
- Status: `accepted`
- Entscheidung: `PreToolUse:Bash` bleibt unregistriert. Die Owner-Grenze gilt
  dort als „höchstens einer, falls aktiviert“.
...
- Status: `accepted`
- Entscheidung: `hooks/claudestack.mjs` besitzt `PostToolUse:Bash` allein.
