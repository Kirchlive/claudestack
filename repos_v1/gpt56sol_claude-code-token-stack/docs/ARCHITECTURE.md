...
Codes native Mechanismen zu verdrängen. Minimaler Produktionspfad:
...
| Surface-ID | Oberfläche | Produktions-Owner | Kardinalität |
|---|---|---|---|
...
Kein `PreToolUse:Bash`-Hook im Default. Dadurch gibt es keinen Command-Rewrite,
keine konkurrierenden Permission-Entscheidungen und keinen unnötigen Prozessstart.
