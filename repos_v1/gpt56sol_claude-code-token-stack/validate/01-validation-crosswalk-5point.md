...
| `OPUS` | Vollprüfung plus Konzept v4 | 276 + 423 Zeilen plus v4-Katalog | 376 Repo-Metadaten, 13 Funktionsläufe, 100-KB-Hook-Payload, SHA/Score-Prüfung | Aktivitäts-/Lizenzsignale sind Lieferfähigkeits-Proxys, keine Funktionsbeweise; keine E2E-Tokenmessung |
...
Wichtige Zähldifferenz: `OPUS` meldet 376 extrahierte Repo-Namen und 374 erreichbare; `GPT` normalisiert 368 unterschiedliche Referenzen und verifiziert 367. Beide Werte bleiben erhalten. Ohne identischen Extraktor und identische Einschlussregeln sind sie nicht direkt austauschbar.
...
| `OPUS` | present | 376 extrahiert, 374 erreichbar; 251er/v4-Katalog, 241 neue Funde gegenüber Seed. | VALIDATION §§3–4,9 | 5 |
...
| `OPUS` | present | Commit, Stars, Lizenz, Archivstatus für 376; 249 als vorläufig freigabefähig; 12 Fences, 60 ohne Lizenz. | VALIDATION §§8–9; KONZEPT Gesetz III | 5 |
...
|---|---|---|
| `C01` | 376/374 versus 368/367 Repozählung | gemeinsamer kanonischer Extraktor und Einschlussregeln |
